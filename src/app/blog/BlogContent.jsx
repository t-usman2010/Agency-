        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <p className="text-lg sm:text-xl text-dark-600 max-w-2xl leading-relaxed">
              Practical insights on development, design, and strategy from the team at TriForge Studio.
            </p>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="container-max">
          <AnimatedSection>
            <Link href={`/blog/${posts[0].slug}`} className="group block">
              <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 bg-dark-50 rounded-2xl overflow-hidden border border-dark-100 card-hover">
                <div className="aspect-[16/10] lg:aspect-auto bg-gradient-to-br from-brand-100 via-brand-50 to-dark-50 flex items-center justify-center min-h-[250px]">
                  <span className="text-brand-400 font-medium">Featured Article</span>
                </div>
                <div className="p-6 sm:p-8 lg:py-10 flex flex-col justify-center">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-dark-900 mb-3 group-hover:text-brand-600 transition-colors">
                    {posts[0].title}
                  </h2>
                  <p className="text-dark-600 leading-relaxed mb-4">{posts[0].excerpt}</p>
                  <div className="flex items-center gap-2 text-sm text-dark-500">
                    <span className="font-medium text-dark-700">{posts[0].author}</span>
                    <span>·</span>
              ...
              <StaggerItem key={post.slug}>
                <Link href={`/blog/${post.slug}`} className="group block h-full">
                  <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-dark-100 card-hover flex flex-col h-full">
                    <div className="aspect-[16/10] bg-gradient-to-br from-brand-50 via-brand-100 to-dark-50 flex items-center justify-center">
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <p className="text-dark-600 text-sm line-clamp-2 flex-1 mb-4">
                        {post.excerpt}
                      </p>
